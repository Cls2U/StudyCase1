...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminAddRoomKind" method="post">
			...
			<table class="table table-bordered table-hover" width="100%">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="kind" value="" id="kind" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						该类日价：
					</td>
