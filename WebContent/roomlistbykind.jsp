...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<li><a href="#">${allRoomKind[kid-1].kind}列表</a></li>
			</ol>
		</div>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 20px; text-align: center;">
		...
		<c:if test="${pageBean.currentPage!=1 }">
		<li>
		   <a href="${pageContext.request.contextPath }/roomListByKind?kid=${kid}&currentPage=${pageBean.currentPage-1}" aria-label="Previous">
		   <span aria-hidden="ture">&laquo;</span>
		   </a>
		</li>
		</c:if>
		<c:forEach begin="1" end="${pageBean.totalPage}" var="page">
		   ...
		   <c:if test="${page!=pageBean.currentPage }">
		   <li><a href="${pageContext.request.contextPath }/roomListByKind?kid=${kid}&currentPage=${page}">${page }</a></li>
		   </c:if>
		</c:forEach>
		...
		<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
		<li>
		   <a href="${pageContext.request.contextPath }/roomListByKind?kid=${kid}&currentPage=${pageBean.currentPage+1}" aria-label="Next">
		   <span aria-hidden="ture">&raquo;</span>
		   </a>
		</li>
		</c:if>
